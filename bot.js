...
❖-|spamo1n|spam2on | spam3on | spam4on | حتى تشغل لسبام بعدة رومات
...
if(!msg.member.hasPermission('ADMINISTRATOR')) return msg.channel.send(':no_entry: | `Adminstrator`للاسف ليس لديك صلاحية يجي ان يكون لديك برمشن!');
let spam = msg.guild.channels.find('name', 'spam1');
 if (!spam) return msg.channel.send('**`spam1`يرجى اضافة روم باسم**' );
setInterval(function(){
	spam.send('spam')
}, 500);
setInterval(function(){
...
if(!msg.member.hasPermission('ADMINISTRATOR')) return msg.channel.send(':no_entry: | `Adminstrator`للاسف ليس لديك صلاحية يجي ان يكون لديك برمشن!');
let spam = msg.guild.channels.find('name', 'spam2');
 if (!spam) return msg.channel.send('**`spam2`يرجى اضافة روم باسم**' );
setInterval(function(){
	spam.send('spam')
}, 500);
setInterval(function(){
...
if(!msg.member.hasPermission('ADMINISTRATOR')) return msg.channel.send(':no_entry: | `Adminstrator`للاسف ليس لديك صلاحية يجي ان يكون لديك برمشن!');
let spam = msg.guild.channels.find('name', 'spam3');
 if (!spam) return msg.channel.send('**`spam3`يرجى اضافة روم باسم**' );
setInterval(function(){
	spam.send('spam')
}, 500);
setInterval(function(){
...
if(!msg.member.hasPermission('ADMINISTRATOR')) return msg.channel.send(':no_entry: | `Adminstrator`للاسف ليس لديك صلاحية يجي ان يكون لديك برمشن!');
let spam = msg.guild.channels.find('name', 'spam4');
 if (!spam) return msg.channel.send('**`spam4`يرجى اضافة روم باسم**' );
setInterval(function(){
	spam.send('spam')
}, 500);
setInterval(function(){
